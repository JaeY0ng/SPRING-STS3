		...
		<div class="axios-block">
			...
			<div class="get">
				...
				<form method="post"
					...
					<input name="id" placeholder="id" /> <input name="text"
						placeholder="text" /> <input name="writer" placeholder="writer" />
					<button>전송</button>
				</form>
			</div>
			<div class="get">
...
/* 	const projectPath = '${pageContext.request.contextPath}';
	 	...
	 	async function fetch_get(){
	 		try{
	 		const response = await fetch(projectPath + "/memo/add_get?id=5050&text=abcd&writer=abcd")
	...
	<script>
		...
		btn5.addEventListener('click',function(){
			...
			.then( resp=>{
					...
					resultBlock.innerHTML = "삭제 완료..."+resp.data;
