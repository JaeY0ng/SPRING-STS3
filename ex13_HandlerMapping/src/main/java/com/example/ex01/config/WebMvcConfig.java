...
public class WebMvcConfig implements WebMvcConfigurer {
	...
	//1) BEAN MAPPING(BeanNameUrlHandlerMapping : 요청 URL 을 동일한 이름을 가진 Bean 에 매핑)
	...
	//2) SimpleUrlHandlerMapping : 개발자가 직접 매핑정보를 저장, 정적자원에 대한 매핑정보 설정이 기본값
	@Bean
	...
	//3) RequestMappingHandlerMapping : Controller 와 매핑되는 URL을 찾아내고 해당 URL 에 대한 요청 처리
	...
	RequestMappingHandlerMapping requestMappingHandlerMapping () throws Exception {
		...
		//URL 에 매핑될 메서드 찾기 (Reflection 이용)
