...
<body>
	...
	<h2>다중 파일 전송(FileDto단위 방식) - 동기 방식</h2>
	<form action="${pageContext.request.contextPath}/file/multiUpload"
		method="post" enctype="multipart/form-data">
	...
	<h2>다중 파일 전송(FileDto단위 방식) - 동기 방식</h2>
	<form action="${pageContext.request.contextPath}/file/multiUpload_dto"
		method="post" enctype="multipart/form-data">
		<input type="text" name="id" /> <input type="text" name="category" />
		<input type="text" name="price" /> <input type="file" name="files"
			multiple /> <input type="submit" value="다중 파일 전송" />
	</form>
